        ...
        <TableBody>
                    {data.map((it, index) => (
                        <TableRowExpandable
                            ...
                            key={it.users?.name}
                            expandContent={<BetalingsDetaljer account_transactions={it.account_transactions} account={it.accounts!} users={it.users!}/>}
                        >
    ...
    return (
        <div className="flex justify-between">
            ...
            <ContextMessage
                ...
                >
                Kunden har initiert en betaling på over 9 800 NOK. 
                    Se over betalingen og vurder risiko for svindel
                Evt ring kunden for bekreftelse
                </ContextMessage>
                <ButtonGroup thin={true} ariaLabel="Knappegruppe">
                    ...
                    <PrimaryButton onClick={() => approveTransaction(account_transactions.id)}>Godkjenn betaling</PrimaryButton>
                </ButtonGroup>
            </div>
        </div>
    )
